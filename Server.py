...
def broadcast(message):
    for client in clients:
        client.send(message)
#Here we define a little function that is going to help us broadcast messages and make the code more readable. What it does is just send a message to each client that is connected and therefore in the clients list. We will use this method in the other methods.
